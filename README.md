# 0x16. C - Simple Shell
  ...
  * Team: Shimelis Adugna

# Learning Objectives
At the end of this project, it is expected to be able to explain to anyone, without the help of Google the following points:

# General Points to explain
- Who designed and implemented the original Unix operating system
- Who wrote the first version of the UNIX shell
- Who invented the `B programming` language (direct predecessor to C programming language)
- Who is `Ken Thompson`
